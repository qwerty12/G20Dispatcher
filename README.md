...
| Info           | [`KEYCODE_INFO`](https://developer.android.com/reference/android/view/KeyEvent#KEYCODE_INFO)       | [`KEYCODE_INFO`](https://developer.android.com/reference/android/view/KeyEvent#KEYCODE_INFO) (read [Keymap](https://kodi.wiki/view/Keymap) and [this](https://github.com/qwerty12/G20Dispatcher/commit/7b72b0b7ea431aacb753f784a33da204f72843db) to make it work)<br>[`KEYCODE_O`](https://developer.android.com/reference/android/view/KeyEvent#KEYCODE_L) (held) - [Player Process Info](https://kodi.wiki/view/Player_process_info#Player_Process_Info)                                                                                          |
